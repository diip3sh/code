            ...
            >
              ...
              {!renderablePatch ? (
                activeReviewIsLoading ? (
                  ...
                  <div className="flex h-full items-center justify-center px-3 py-2 text-xs text-muted-foreground/70 font-sans">
                    <p>
