...
export const DEFAULT_KEYBINDINGS: ReadonlyArray<KeybindingRule> = [
  ...
  { key: "mod+2", command: "thread.jump.2", when: "!terminalFocus" },
  { key: "mod+3", command: "thread.jump.3", when: "!terminalFocus" },
  { key: "mod+4", command: "thread.jump.4", when: "!terminalFocus" },
  { key: "mod+5", command: "thread.jump.5", when: "!terminalFocus" },
  { key: "mod+6", command: "thread.jump.6", when: "!terminalFocus" },
  { key: "mod+7", command: "thread.jump.7", when: "!terminalFocus" },
  { key: "mod+8", command: "thread.jump.8", when: "!terminalFocus" },
  { key: "mod+9", command: "thread.jump.9", when: "!terminalFocus" },
